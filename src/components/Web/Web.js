    ...
    return (
        <div className="web">
            <Helmet
                ...
                meta={[
                    {"name": "description", "content": "Создание сайтов в Санкт-Петербурге. Разработка и продвижение сайтов! Современный и продающий дизайн! Команда профессиональных дизайнеров и разработчиков! ГК 'Вымпел'"}
                ]}
                link={[
